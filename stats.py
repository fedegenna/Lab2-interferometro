...
class stats :
	...
	def var_variance (self, bessel = True):
	
		var_var = 2 * self.variance() * self.variance() / (len (self.sample) - 1)
		return var_var
		
    # ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- 
    
	def error_variance (self, bessel = True):
	
		error_var = sqrt (self.var_variance())
		return error_var
